        ...
        <div className="pb-20 pt-36">
            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    ...
                    <TextGenerateEffect words="Modern Portfolio lorem ipsum set"
                                        className="lg:text-6xl md:text-5xl text-[40px] text-center"/>
                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl '>
                        Hi, I&apos;m a web developer with a passion for building beautiful and functional websites.
                    </p>
                </div>
            </div>
            <a href="#about" className='w-full text-center'>
                <MagicButton
                    title="Show my work"
